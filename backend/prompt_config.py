...
2. **profile_summary** (RESUMEN DEL PERFIL) - ESTRUCTURA OBLIGATORIA (One-Shot): "Profesional con experiencia en 5 posiciones, Ana destaca por su capacidad de Liderazgo y Comunicación. Su propuesta de valor reside en la combinación de habilidades técnicas y soft skills, con especial interés en roles administrativos en entornos híbridos. Su perfil es adecuado para entornos que valoren la autonomía, la organización y el aprendizaje continuo. Áreas a potenciar: Gestión del tiempo - Oportunidad de mejora." (Adapta los datos al candidato, pero MANTÉN LA ESTRUCTURA EXACTA).
