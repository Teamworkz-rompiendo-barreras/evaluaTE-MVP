...
# --- ESQUEMAS DE ENTRADA (JUEGO Y USUARIO) ---
...
class JobPreference(BaseModel):
    ...
    hasDisabilityCert: Optional[bool] = Field(default=None, description="Dato de salud (RGPD Art. 9)")
...
class GameDecisionLog(BaseModel):
    ...
    totalSteps: int
    totalTime: int # En milisegundos (performance.now)
    accessibilityUsed: bool

# --- ESQUEMAS DE SALIDA (IA Y REPORTES) ---
