...
exports.analyzeCV = exports.generatePDF = void 0;
const pdfService_1 = require("../services/pdfService"); // Asegúrate de que la ruta sea correcta
...
const generatePDF = async (req, res) => {
    try {
        const pdfBuffer = await (0, pdfService_1.createPdf)(req.body);
...
async function analyzeCVWithPython(pdfBuffer) {
...
`;
            ...
            const pythonProcess = (0, child_process_1.spawn)(path_1.default.join(__dirname, '../../venv/bin/python'), ['-c', pythonScript], {
                cwd: path_1.default.join(__dirname, '../../'), // Ir al directorio backend
                env: {
                    ...process.env,
