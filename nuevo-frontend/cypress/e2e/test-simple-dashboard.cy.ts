/* eslint-env cypress */
// cypress/e2e/test-simple-dashboard.cy.ts

describe('Test Simple Dashboard', () => {
  beforeEach(() => {
  ...
  it('Verifica que el dashboard se carga sin overlays', () => {
    ...
    // 7) Verificar que navega al juego
