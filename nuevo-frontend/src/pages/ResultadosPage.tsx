      ...
      <div className="bg-white rounded-lg shadow-md p-6 md:p-8 mb-8 print:bg-white print:shadow-none print:p-0">
        ...
        {iaReport && (
          <>
            ...
            {!feedbackSent && (
              <div className="bg-white text-gray-900 rounded-lg shadow-md p-6 mb-8 print-hidden dark:bg-white dark:text-black dark:border dark:border-gray-300">
                <form onSubmit={handleFeedbackSubmit}>
                  <label className="block mb-2 font-semibold">¿Te resultó útil este informe?</label>
                  <div className="flex gap-4 mb-4">
                    <label className="flex items-center gap-2 px-3 py-1 rounded-full border border-gray-300 bg-white">
                  ...
                  <textarea className="w-full border rounded p-2 mb-2 bg-white text-gray-900 border-gray-300" rows={2} value={feedback.comment} onChange={e => setFeedback(f => ({...f, comment: e.target.value}))} />
