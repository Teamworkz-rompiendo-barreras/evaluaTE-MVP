...
# Frontend info
FRONTEND_URL=$(az staticwebapp show --name evaluador-frontend-fzbhemgtetfeeme6 --resource-group evaluador-frontend-fzbhemgtetfeeme6_group --query "defaultHostname" -o tsv)
...
echo "• Ver logs del frontend: az staticwebapp show --name evaluador-frontend-fzbhemgtetfeeme6 --resource-group evaluador-frontend-fzbhemgtetfeeme6_group"
echo "• Ver logs del backend: az webapp log tail --name evaluador-backend --resource-group evaluador-backend_group"
echo "• Estado del frontend: az staticwebapp show --name evaluador-frontend-fzbhemgtetfeeme6 --resource-group evaluador-frontend-fzbhemgtetfeeme6_group --query state"
