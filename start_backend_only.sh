...
# Script para iniciar solo el backend de EvaluaTE
echo "🚀 Iniciando solo el backend de EvaluaTE..."
...
show_info() {
    ...
    echo ""
    echo -e "${YELLOW}💡 Para iniciar el frontend en otra terminal:${NC}"
    echo -e "   cd nuevo-frontend && npm run dev"
    echo ""
    echo -e "${YELLOW}💡 Para detener el backend:${NC}"
...
echo -e "${BLUE}⏳ Backend ejecutándose... Presiona Ctrl+C para detener${NC}"
wait 